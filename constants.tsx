...
// Fix: Import Category type from types.ts to resolve 'Cannot find name Category' error
...
export const ICONS = {
  ...
  Tasks: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 7v14"/><path d="M9 18l3 3 3-3"/><circle cx="12" cy="5" r="2"/></svg>
  ),
  Habits: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v10"/><path d="M18.42 4.41a10 10 0 1 1-12.84 0"/></svg>
  ),
  Goals: () => (
...
export const CATEGORIES: Category[] = ['Trabalho', 'Pessoal', 'Saúde', 'Estudos', 'Finanças', 'Outros'];
